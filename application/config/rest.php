...
// $config['rest_enable_keys'] = FALSE; // To disable API keys
// $config['rest_api_keys'] = array(); // Optionally define API keys here
// $config['rest_default_format'] = 'json'; // Default format (json/xml)
